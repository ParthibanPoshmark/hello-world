freeStyleJob('gdf-facebook/gd-facebook-ad_spend-141632906_sync') {
	description("<html>"+
  "<br/>"+
  "<br/>"+
  "<table>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": Pulls Ad spend details from facebook for account 141632906 "+
      "</td>"+
   	"</tr>"+
...
"</html>")
  ...
  parameters{
    ...
    stringParam('accounts', 'act_141632906' , null)
  }
