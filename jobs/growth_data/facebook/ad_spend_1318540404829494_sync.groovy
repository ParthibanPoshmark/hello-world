freeStyleJob('gdf-facebook/gd-facebook-ad_spend-1318540404829494_sync') {
	description("<html>"+
  "<br/>"+
  "<br/>"+
  "<table>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": Pulls Ad spend details from facebook for account 1318540404829494 "+
      "</td>"+
   	"</tr>"+
...
"</html>")
  ...
  parameters{
    ...
    stringParam('accounts', 'act_1318540404829494' , null)
  }
