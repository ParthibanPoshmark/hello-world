freeStyleJob('gdf-facebook/gd-facebook-ad_spend-1551884058161793_sync') {
	description("<html>"+
  "<br/>"+
  "<br/>"+
  "<table>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": Pulls Ad spend details from facebook for account 1551884058161793 "+
      "</td>"+
   	"</tr>"+
...
"</html>")
  ...
  parameters{
    ...
    stringParam('accounts', 'act_1551884058161793' , null)
  }
  ...
  steps{
      shell('#!/bin/bash --login -x\n\nbash $WORKSPACE/docker_scripts/facebook/fb_ad_spend_v3_api.sh')
  }
