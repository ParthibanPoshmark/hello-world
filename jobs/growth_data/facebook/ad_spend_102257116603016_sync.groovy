freeStyleJob('gdf-facebook/gd-facebook-ad_spend-102257116603016_sync') {
	description("<html>"+
  "<br/>"+
  "<br/>"+
  "<table>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": Pulls Ad spend details from facebook for account 102257116603016 "+
      "</td>"+
   	"</tr>"+
...
"</html>")
  ...
  parameters{
    ...
    stringParam('accounts', 'act_102257116603016' , null)
  }
