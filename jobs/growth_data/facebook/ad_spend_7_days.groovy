freeStyleJob('gdf-facebook/gd-facebook-ad_spend-7_days') {
	description("<html>"+
  "<br/>"+
  "<br/>"+
  "<table>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": Pulls Ad spend details for all accounts from facebook for the last 7 days "+
      "</td>"+
   	"</tr>"+
...
"</html>")
  ...
  parameters{
    ...
    booleanParam('skip_yaga', true, null)
  }
