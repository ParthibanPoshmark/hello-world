freeStyleJob('gdf-pinterest/gd-pinterest-ad_spend_hourly-sync') {
	description("<html>"+
  "<br/>"+
  "<br/>"+
  "<table>"+
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": Pulls ad spend information from pinterest at hourly level "+
      "</td>"+
   	"</tr>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": pinterest/ad_spend_hourly.rake "+
      "</td>"+
   	"</tr>"+
...
"</html>")
  ...
  steps{
    shell('#!/bin/bash --login -x\n\nbash $WORKSPACE/docker_scripts/spend_estimates/import_spend_estimates_pinterest.sh')
  }
