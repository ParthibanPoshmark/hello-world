freeStyleJob('gdf-other_partners/gd-other_partners-shopzilla_spend') {
	description("<html>"+
  "<br/>"+
  "<br/>"+
  "<table>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": Pulls ad spend information from shpozilla for the last 5 days "+
      "</td>"+
   	"</tr>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ":	other_partners/shopzilla_spend.rake "+
      "</td>"+
   	"</tr>"+
...
"</html>")
  ...
  steps{
    shell('#!/bin/bash --login -x\n\nbash $WORKSPACE/docker_scripts/spend/shopzilla_auto_spend_import.sh')
  }
