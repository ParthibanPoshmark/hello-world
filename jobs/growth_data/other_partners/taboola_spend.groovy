freeStyleJob('gdf-other_partners/gd-other_partners-taboola_spend') {
	description("<html>"+
  "<br/>"+
  "<br/>"+
  "<table>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": Pulls ad spend information from taboola for the last 7 days "+
      "</td>"+
   	"</tr>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ":	other_partners/taboola_spend.rake "+
      "</td>"+
   	"</tr>"+
