freeStyleJob('gdf-other_partners/gd-other_partners-unity_spend') {
	description("<html>"+
  "<br/>"+
  "<br/>"+
  "<table>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ": Pulls ad spend information from unity for the last 5 days "+
      "</td>"+
   	"</tr>"+
    ...
    "<tr>"+
      ...
      "</td>"+
      "<td style='font-family: Consolas,monospace;'>"+
        ":	other_partners/unity_spend.rake "+
      "</td>"+
   	"</tr>"+
...
"</html>")
  ...
  steps{
    shell('#!/bin/bash --login -x\n\nbash $WORKSPACE/docker_scripts/spend/unity_ads_import_spend.sh')
  }
